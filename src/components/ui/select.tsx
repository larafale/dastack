...
const selectVariants = cva(
  'data-[placeholder]:text-placeholder flex w-full items-center justify-between whitespace-nowrap transition-colors disabled:cursor-not-allowed disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0',
  {
    variants: {
      variant: {
